...
export default function FooterContactForm() {
  return (
    <form className="bg-accentDarkSecondary px-6 item-center sm:px-8 lg:px-12 py-6 w-full md:w-1/2 ">
      <div className="w-full">
        <h2 className="text-3xl font-bold mb-5 text-dark text-center uppercase">
          reach us
        </h2>
        <div className="flex text black flex-col sm:flex-row md:flex-col lg:flex-row gap-4 mb-4">
          <input
            type="text"
            placeholder="Name"
            name="name"
